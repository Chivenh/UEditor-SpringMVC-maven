...
var templates = [
    {
        "title":"找船",
        "pre":"hjsPres/findShip.png",
        "preHtml":"<table width=\"421\" >" + "    <colgroup>" + "        <col width=\"90\" span=\"4\" style=\";width:89px\"/>" + "        <col width=\"64\" style=\"width:64px\"/>" + "    </colgroup>" + "    <tbody>" + "        <tr style=\"height:19px\" class=\"firstRow\">" + "            <td width=\"89\" style=\"\">" + "                货物名称" + "            </td>" + "            <td width=\"89\" style=\"border-left: none;\">" + "                数量" + "            </td>" + "            <td width=\"89\" style=\"border-left: none;\">" + "                起止港" + "            </td>" + "            <td width=\"89\" style=\"border-left: none;\">" + "                装载计划" + "            </td>" + "        </tr>" + "        <tr style=\"height:19px\">" + "            <td style=\"border-top: none;\" class='ue_t'></td>" + "            <td style=\"border-top:none;border-left:none\" class='ue_t'></td>" + "            <td style=\"border-top:none;border-left:none\" class='ue_t'></td>" + "            <td style=\"border-top:none;border-left:none\" class='ue_t'></td>" + "        </tr>" + "        <tr style=\"height:19px\">" + "            <td style=\"\"></td>" + "            <td></td>" + "            <td></td>" + "            <td></td>" + "        </tr>" + "    </tbody>" + "</table>" + "<p>" + "    <br/>" + "</p>",
        "html":"<table width=\"421\" >" +
            "    <colgroup>" +
            "        <col width=\"90\" span=\"4\" style=\";width:89px\"/>" +
            ...
            "                货物名称" +
            "            </td>" +
            "            <td width=\"89\" style=\"border-left: none;\">" +
            "                数量" +
            "            </td>" +
            "            <td width=\"89\" style=\"border-left: none;\">" +
            "                起止港" +
            ...
            "            <td style=\"border-top: none;\" class='ue_t'></td>" +
            "            <td style=\"border-top:none;border-left:none\" class='ue_t'></td>" +
            "            <td style=\"border-top:none;border-left:none\" class='ue_t'></td>" +
            "            <td style=\"border-top:none;border-left:none\" class='ue_t'></td>" +
            "        </tr>" +
            "        <tr style=\"height:19px\">" +
    ...
    {
        "title":"找货",
        "pre":"hjsPres/findGoods.png",
        "preHtml":"<table width=\"421\" >" + "    <colgroup>" + "        <col width=\"90\" span=\"4\" style=\";width:89px\"/>" + "        <col width=\"64\" style=\"width:64px\"/>" + "    </colgroup>" + "    <tbody>" + "        <tr style=\"height:19px\" class=\"firstRow\">" + "            <td width=\"89\" style=\"\">" + "                船舶类型" + "            </td>" + "            <td width=\"89\" style=\"border-left: none;\">" + "                载量" + "            </td>" + "            <td width=\"89\" style=\"border-left: none;\">" + "                船龄" + "            </td>" + "            <td width=\"89\" style=\"border-left: none;\">" + "                停泊港" + "            </td>" + "        </tr>" + "        <tr style=\"height:19px\">" + "            <td style=\"border-top: none;\" class='ue_t'></td>" + "            <td style=\"border-top:none;border-left:none\" class='ue_t'></td>" + "            <td style=\"border-top:none;border-left:none\" class='ue_t'></td>" + "            <td style=\"border-top:none;border-left:none\" class='ue_t'></td>" + "        </tr>" + "        <tr style=\"height:19px\">" + "            <td style=\"\"></td>" + "            <td></td>" + "            <td></td>" + "            <td></td>" + "        </tr>" + "    </tbody>" + "</table>" + "<p>" + "    <br/>" + "</p>",
        "html":"<table width=\"421\" >" +
            "    <colgroup>" +
            "        <col width=\"90\" span=\"4\" style=\";width:89px\"/>" +
            "        <col width=\"64\" style=\"width:64px\"/>" +
    ...
    {
        "title":"招聘",
        "pre":"hjsPres/findMan.png",
        "preHtml":"<table width=\"421\">" + "    <colgroup>" + "        <col width=\"90\" span=\"4\" style=\";width:89px\"/>" + "        <col width=\"64\" style=\"width:64px\"/>" + "    </colgroup>" + "    <tbody>" + "        <tr style=\"height:19px\" class=\"firstRow\">" + "            <td width=\"89\" style=\"\">" + "                公司名称" + "            </td>" + "            <td width=\"89\" style=\"border-left: none;\">" + "                船舶类型" + "            </td>" + "            <td width=\"89\" style=\"border-left: none;\">" + "                岗位" + "            </td>" + "            <td width=\"89\" style=\"border-left: none;\">" + "                人数" + "            </td>" + "        </tr>" + "        <tr style=\"height:19px\">" + "            <td style=\"border-top: none;\" class='ue_t'></td>" + "            <td style=\"border-top:none;border-left:none\" class='ue_t'></td>" + "            <td style=\"border-top:none;border-left:none\" class='ue_t'></td>" + "            <td style=\"border-top:none;border-left:none\" class='ue_t'></td>" + "        </tr>" + "        <tr style=\"height:19px\">" + "            <td style=\"\"></td>" + "            <td></td>" + "            <td></td>" + "            <td></td>" + "        </tr>" + "    </tbody>" + "</table>" + "<p>" + "    <br/>" + "</p>",
        "html":"<table width=\"421\">" +
            "    <colgroup>" +
            "        <col width=\"90\" span=\"4\" style=\";width:89px\"/>" +
            "        <col width=\"64\" style=\"width:64px\"/>" +
    ...
    {
        "title":"求职",
        "pre":"hjsPres/findJob.png",
        "preHtml":"<table width=\"421\">" + "    <colgroup>" + "        <col width=\"90\" span=\"4\" style=\";width:89px\"/>" + "        <col width=\"64\" style=\"width:64px\"/>" + "    </colgroup>" + "    <tbody>" + "        <tr style=\"height:19px\" class=\"firstRow\">" + "            <td width=\"89\" style=\"\">" + "                应聘岗位" + "            </td>" + "            <td width=\"89\" style=\"border-left: none;\">" + "                所持证书" + "            </td>" + "            <td width=\"89\" style=\"border-left: none;\">" + "                航线" + "            </td>" + "            <td width=\"89\" style=\"border-left: none;\">" + "                船舶类型" + "            </td>" + "        </tr>" + "        <tr style=\"height:19px\">" + "            <td style=\"border-top: none;\" class='ue_t'></td>" + "            <td style=\"border-top:none;border-left:none\" class='ue_t'></td>" + "            <td style=\"border-top:none;border-left:none\" class='ue_t'></td>" + "            <td style=\"border-top:none;border-left:none\" class='ue_t'></td>" + "        </tr>" + "        <tr style=\"height:19px\">" + "            <td style=\"\"></td>" + "            <td></td>" + "            <td></td>" + "            <td></td>" + "        </tr>" + "    </tbody>" + "</table>" + "<p>" + "    <br/>" + "</p>",
        "html":"<table width=\"421\">" +
            "    <colgroup>" +
            "        <col width=\"90\" span=\"4\" style=\";width:89px\"/>" +
            "        <col width=\"64\" style=\"width:64px\"/>" +
    ...
    {
        "title":"求购",
        "pre":"hjsPres/findSeller.png",
        "preHtml":"<table width=\"421\">" + "    <colgroup>" + "        <col width=\"90\" span=\"4\" style=\";width:89px\"/>" + "        <col width=\"64\" style=\"width:64px\"/>" + "    </colgroup>" + "    <tbody>" + "        <tr style=\"height:19px\" class=\"firstRow\">" + "            <td width=\"89\" style=\"\">" + "                船舶类型" + "            </td>" + "            <td width=\"89\" style=\"border-left: none;\">" + "                载量" + "            </td>" + "            <td width=\"89\" style=\"border-left: none;\">" + "                船龄" + "            </td>" + "            <td width=\"89\" style=\"border-left: none;\">" + "                意向价格" + "            </td>" + "        </tr>" + "        <tr style=\"height:19px\">" + "            <td style=\"border-top: none;\" class='ue_t'></td>" + "            <td style=\"border-top:none;border-left:none\" class='ue_t'></td>" + "            <td style=\"border-top:none;border-left:none\" class='ue_t'></td>" + "            <td style=\"border-top:none;border-left:none\" class='ue_t'></td>" + "        </tr>" + "        <tr style=\"height:19px\">" + "            <td style=\"\"></td>" + "            <td></td>" + "            <td></td>" + "            <td></td>" + "        </tr>" + "    </tbody>" + "</table>" + "<p>" + "    <br/>" + "</p>",
        "html":"<table width=\"421\">" +
            "    <colgroup>" +
            "        <col width=\"90\" span=\"4\" style=\";width:89px\"/>" +
            "        <col width=\"64\" style=\"width:64px\"/>" +
